...
const FaqCard = () => {
  const faqs = [
    ...
    {
      question:
        "How does WoyTrip ensure affordable pricing without compromising quality?",
      answer:
    ...
    {
      question:
        "Does WoyTrip offer assistance with travel documentation and visas?",
      answer:
...
const FAQItem = ({
  ...
  return (
    <div className="border border-gray-300 bg-white rounded-lg shadow-md overflow-hidden" id="faq">
      <button
